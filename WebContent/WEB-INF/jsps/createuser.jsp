...
<body>
	...
	<sf:form method="post"
		action="${pageContext.request.contextPath}/docreate" commandName="job">
		...
		<table class="formtable">
			...
			<tr>
				<td class="label">Your Profile:</td>
				<td><sf:textarea path="text" class="control" name="text" rows="10" cols="10"></sf:textarea><br/><sf:errors path="text" cssClass="error"></sf:errors></td>
			</tr>
			<tr>
				<td class="label"></td>
